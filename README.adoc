:extension: https://github.com/hivemq/hivemq-dns-cluster-discovery-extension
...
If you want to contribute to HiveMQ DNS Cluster Discovery Plugin, see the link:CONTRIBUTING.md[contribution guidelines].

= License

HiveMQ DNS Cluster Discovery Plugin is licensed under the `APACHE LICENSE, VERSION 2.0`. A copy of the license can be found link:LICENSE.txt[here].
